...
import br.com.projetomedico.dao.ConvenioDAOImpl;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                request.setAttribute("cidades", dao.carregarCidades());
                 
                ConvenioDAOImpl daoconvenio = new ConvenioDAOImpl();
                
                request.setAttribute("convenios", daoconvenio.carregarConvenios());
                
                request.getRequestDispatcher("cadastrarmedico.jsp").forward(request, response);
            } catch (Exception e) {
                System.out.println("Problemas ao carregar Cidades! Erro: " + e.getMessage());
                e.printStackTrace();
            }
